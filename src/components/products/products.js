const products = [
    ...
    {id:4, name: "Lampara Cat White", category:"velador led", price: 1699, img:"https://i.postimg.cc/VkL6n1T3/lampara-cat3.jpg", stock:20, description:"Con la luz de esta preciosa y alegre lámpara quitamiedos con forma de gato, Funciona con luces LED de larga duración que evitan el calentamiento de la lámpara, por lo que es segura para los niños.Dispone de botón de encendido y apagado en su base."},
    {id:5, name: "Lampara Cat Violet", category:"velador led", price: 1199, img: "https://i.postimg.cc/fLXTDbt0/lampara-cat6.jpg", stock:10, description:"Tiernos gatito de silicona con luz LED para decorar la habitación de los niños o incluso para jugar con ellos. Contiene debajo un botón de encendido. Luego la luz se puede encender con un golpeSe carga mediante un cargador USB. Posee una luz LED que indica cuando se esta cargando"},
    {id:6, name: "Lampara Cat 3D", category:"velador led" , price: 999, img: "https://i.postimg.cc/Dy5f2HZ5/lampara-cat7.jpg", stock:11, description:"Lámpara para decorar y ambientar “Tu Espacio”.Tecla para encender/apagar y transformador para que puedas enchufarlo directamente a la corriente! No necesitás nada adicional"},
    ...
    {id:8, name: "Lampara Reno", categor: "velador led", price: 799, img: "https://i.postimg.cc/15RPYBHF/map.jpg", stock:22, description:"Perfecta como luz anti-miedos, lámpara de mesita de noche o punto de luz.Viene presentada en caja ilustrada promocional lista para regalar!"},
    ...
    {id:15, name: "Velador Cat", category: "iluminacion", price: 799, img:"https://i.postimg.cc/1XjWByBJ/lampara-cat4.jpg", stock:25, description:"Velador Tiernos animales con Luz Led Cable Usb Recargable,Tecla para encender/apagar, ideal para el escritorio, varios colores disponibles"},
    {id:16, name: "Velador Bear", category: "iluminacion", price: 989, img:"https://i.postimg.cc/y6QrsTKc/lampara-cat5.jpg", stock:25, description:" Velador Lámpara Luz Led Cable Usb Recargable,Tecla para encender/apagar, ideal para el escritorio, varios colores disponible"},
    ...
    {id:18, name: "Cortina Led", category: "Cortinas", price: 2999, img:"https://i.postimg.cc/Vv9XL1M3/ddddddd.png", stock:25, description:"Cortina guirnalda tipo red. Los usos son infinitos y van en la originalidad de tus ideas, no levantan temperatura"},
    ...
    {id:20, name: "Lluvia Led Multicolor", category: "Cortinas", price: 2989, img:"https://i.postimg.cc/7hcrh8kn/cortina.jpg", stock:25, description:"cortina de 144 Led, Color de Luz Multicolor, Con controlador de efectos fijo e intermitentes"}
]
